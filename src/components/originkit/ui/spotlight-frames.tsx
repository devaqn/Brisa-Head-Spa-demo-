// @ts-nocheck -- codigo vendorizado pelo CLI do Originkit (`originkit add`).
// Nao foi escrito para o `noUncheckedIndexedAccess` deste projeto e acusa
// quatro erros de indice que sao falsos positivos aqui. Preferimos isolar o
// arquivo a afrouxar o tsconfig do site inteiro. Os tipos que ele exporta
// continuam valendo em quem importa, entao o uso em galeria.tsx segue checado.
// Se rodar `originkit add spotlight-frames` de novo, recoloque estas linhas.
"use client"
